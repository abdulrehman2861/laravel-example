...
@section('content')
    <div style="margin:40px">
        <div class="card p-4">
            ...
            <livewire:dashboard.warehouse.warehouse-list />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Create Warehouse</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="POST" action="{{ route('dashboard.warehouse.store') }}">
