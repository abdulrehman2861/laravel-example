            ...
            <div class="card-body">
              ...
              <div class="row table-setting" style="padding:10px">
                  ...
                  <table class="table table-bordered dataTable" id="purchases-table" role="grid"
                    ...
                    <thead>
                      <tr role="row">
                        <th title="+" class="text-center align-middle sorting" tabindex="0"
                          aria-controls="purchases-table" rowspan="1" colspan="1" style="width: 20px;"
                          aria-label="+: activate to sort column ascending">+</th>
                        <th title="Reference" class="text-center align-middle sorting" tabindex="0"
                          aria-controls="purchases-table" rowspan="1" colspan="1" style="width: 86px;"
                          aria-label="Reference: activate to sort column ascending">Reference</th>
                        <th title="Supplier" class="text-center align-middle sorting" tabindex="0"
                          aria-controls="purchases-table" rowspan="1" colspan="1" style="width: 155px;"
                        ...
                        <th title="Status" class="text-center align-middle sorting_disabled" rowspan="1" colspan="1"
                          style="width: 63px;" aria-label="Status">Status</th>
                        <th title="Total Amount" class="text-center align-middle sorting_disabled" rowspan="1"
                          colspan="1" style="width: 112px;" aria-label="Total Amount">Total Amount</th>
                        <th title="Payment Status" class="text-center align-middle sorting_disabled" rowspan="1"
                          colspan="1" style="width: 126px;" aria-label="Payment Status">Payment Status</th>
                        <th title="Ship To" class="text-center align-middle sorting_disabled" rowspan="1" colspan="1"
                          style="width: 76px;" aria-label="Ship To">Ship To</th>
                        <th title="Action" class="text-center align-middle sorting_disabled" rowspan="1" colspan="1"
                          style="width: 96px;" aria-label="Action">Action</th>
                      </tr>
                      <tr>
                        <th class="text-center align-middle" rowspan="1" colspan="1"><input style="width: 80px;"></th>
                        <th class="text-center align-middle" rowspan="1" colspan="1"><input style="width: 80px;"></th>
                        <th class="text-center align-middle" rowspan="1" colspan="1"><input style="width: 80px;"></th>
                        <th class="text-center align-middle" rowspan="1" colspan="1"><input style="width: 80px;"></th>
                        <th class="text-center align-middle" rowspan="1" colspan="1"><input style="width: 80px;"></th>
                    ...
                    <tbody>
                      <tr class="odd">
                        <td class=" text-center align-middle">
                          <div class="btn-group dropleft">
                            ...
                            <div class=" d-flex flex-wrap align-items-center">
                              ...
                              <input type="checkbox" class="form-check-input receive" name="receive[]" value="3"
                                onchange="checkbox()">
                        ...
                        <td class=" text-center align-middle">xyz Glass manufacturer</td>
                        ...
                        <td class=" text-center align-middle">
                          <div class="btn-group dropleft">
                            <div class=" d-flex flex-wrap align-items-center">
                              ...
                              <a class="btn btn-sm btn-success mfs-auto mfe-1 rec" href="#" onclick="receive(3)">
                                <i class="bi bi-save-fill"></i> Receive
                              </a>
                  ...
                  <div class="row">
                    <div class="col-md-5">
                      <div class="dataTables_info" id="purchases-table_info" role="status" aria-live="polite">Showing 1
                    ...
                    <div class="col-md-7 mt-2">
                      <div class="dataTables_paginate paging_simple_numbers" id="purchases-table_paginate"
                        ...
                        <ul class="pagination">
                          <li class="paginate_button page-item previous disabled" id="purchases-table_previous"><a
                              href="#" aria-controls="purchases-table" data-dt-idx="0" tabindex="0"
                              class="page-link">Previous</a></li>
                          <li class="paginate_button page-item active"><a href="#" aria-controls="purchases-table"
                              data-dt-idx="1" tabindex="0" class="page-link">1</a></li>
                          <li class="paginate_button page-item next disabled" id="purchases-table_next"><a href="#"
                              aria-controls="purchases-table" data-dt-idx="2" tabindex="0" class="page-link">Next</a>
                          </li>
                        </ul>
                      </div>
                    </div>
