...
@section('content')
    ...
    <form method="POST" action="{{ route('dashboard.supplier.update',$supplier->id) }}">
        @csrf
        <button style="margin-left:50px" class="btn btn-primary btn-sm">Update Supplier <i class="bi bi-check"></i></button>
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <p class="mg-b-10">Supplier Name <span style="color:red">*</span></p>
                                                <input type="text" value="{{$supplier->name}}" name="name" value="{{$supplier->name}}" class="form-control"
                                                     required>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{$supplier->phone_alternative}}" name="phone_alternative" class="form-control"
                                                    >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{$supplier->website}}" name="website" class="form-control"
                                                    >
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12 ">
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea class="form-control" name="note" rows="4">{{$supplier->note}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
