...
<form action="{{route('dashboard.currency.update', $currency->id)}}" method="POST">
    @csrf        <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="form-row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$currency->name}}" name="name" required="">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$currency->thousand_separator}}" name="thousand_separator" required="">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="decimal_separator">Decimal Separator <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" value="{{$currency->decimal_separator}}" name="decimal_separator" required="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 d-none">
                            <div class="form-group">
                                {{-- <label for="decimal_separator">Decimal Separator <span class="text-danger">*</span></label> --}}
                                <input type="text" class="form-control" value="{{$currency->exchange_rate}}" name="exchange_rate"  required="">
                            </div>
                        </div>
                    </div>
                </div>
