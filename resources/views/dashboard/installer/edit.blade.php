...
@section('content')
    ...
    <form method="POST" action="{{ route('dashboard.installer.update',$installer->id) }}">
        @csrf
        <button style="margin-left:50px" class="btn btn-primary btn-sm">Update Installer <i class="bi bi-check"></i></button>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="first_name" value="{{$installer->first_name}}" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="email" class="form-control"
                                                    name="example-text-input" value="{{$installer->email}}">
                                            </div>
                                            <div class="form-group">
                                                <p class="mg-b-10">Phone Number  </p>
                                                <input type="text" name="phone" class="form-control"
                                                    name="example-text-input" value="{{$installer->phone}}" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                           <div class="form-group">
                                                ...
                                                <input type="text" name="last_name" class="form-control"
                                                    name="example-text-input" value="{{$installer->last_name}}">
                                            </div>
                                            <div class="form-group">
                                                <p class="mg-b-10">Social Security Numbe </p>
                                                <input type="text" name="social_security_number" class="form-control"
                                                    name="example-text-input" value="{{$installer->social_security_number}}">
                                            </div>
                                            <div class="form-group">
                                                <p class="mg-b-10">Identity Number </p>
                                                <input type="text" name="identity_number" class="form-control"
                                                    name="example-text-input" value="{{$installer->identity_number}}">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="city" class="form-control"
                                                    name="example-text-input" value="{{$installer->city}}">
                                            </div>
                                        ...
                                        <div class="col-md-6 d-none">
                                           <div class="form-group">
                                                ...
                                                <input type="text" name="country" class="form-control"
                                                    name="example-text-input" value="{{$installer->country}}">
                                            </div>
                                        ...
                                        <div class="col-md-12 ">
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea class="form-control" name="address" rows="4">{{$installer->address}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
