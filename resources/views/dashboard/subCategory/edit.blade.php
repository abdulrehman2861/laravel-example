...
@section('content')
        ...
        <div class="card w-50 mx-auto" role="document">
            <div class="">
                ...
                <form method="POST" action="{{ route('dashboard.subcategory.update', $category->id) }}">
                    <div class="modal-body">
                        ...
                        <select class="form-control " name="parent_id">
                            ...
                            @forelse ($categories as $parentCategory)
                                <option value="{{ $parentCategory->id }}" @if($parentCategory->id == $category->parent_id) selected="true"  @endif>
                                    {{ $parentCategory->name }}
                                </option>
                            @empty
