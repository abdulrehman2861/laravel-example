        ...
        <div class="card p-4">
            ...
            <div class="mb-4 d-flex justify-content-between">
                ...
                <a data-toggle="modal" data-target="#exampleModal" class="btn btn-primary">
                    Add Feature + <i class="bi bi-plus"></i>
                </a>
            ...
            <livewire:dashboard.feature.feature-list />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Create Feature</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="POST" action="{{ route('dashboard.feature.store') }}">
