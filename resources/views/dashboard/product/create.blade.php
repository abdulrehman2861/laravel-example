...
@section('content')
<form id="productForm" action="{{ route('dashboard.product.store') }}" method="post" class="repeater"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-sm" style="margin-top:30px">
                                ...
                                <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                    ...
                                    <select class="form-control select2-with-search" name="supplier_id">
                                        <option selected="true" disabled>
                                            Select Suppier
                                        </option>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="row row-sm mg-b-20" style="margin:10px">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <select class="form-control select2-with-search glass" name="calibration">
                ...
                <div class="card-body">
                    ...
                    <div class="row row-sm mg-b-20">
                        <div class="col-lg-3">
                            ...
                            <input class="form-control" name="cost" placeholder="Enter Cost" type="text"
                                value="{{ old('cost') }}">
                        </div><!-- col-4 -->
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            ...
                            <input class="form-control" name="alert_quantity" placeholder="Enter Alert Quantity"
                                type="text" value="{{ old('alert_quantity') }}">
                        </div><!-- col-4 -->
                    </div>
                    <div class="row row-sm mg-b-20 " style="margin-top:30px">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            ...
                            <input class="form-control" name="tax" placeholder="Enter Tax" type="text"
                                value="{{ old('tax') }}">
                        </div><!-- col-4 -->
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            ...
                            <select class="form-control select2-with-search" name="tax_type">
                                ...
                                @forelse ($taxTypes as $key => $tax_type)
                                    <option value="{{ $tax_type }}"
                                        {{ old('supplier_id') === $tax_type ? 'selected' : '' }}>
                                        {{ $tax_type }}
                                    </option>
                                @empty
                                    <option selected="true" disabled>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            ...
                            <input class="form-control" name="unit" placeholder="Enter Unit" type="text"
                                value="{{ old('unit') }}">
                        </div><!-- col-4 -->
                    </div>
                    <div class="row row-sm mg-b-20">
