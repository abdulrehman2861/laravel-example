    ...
    <div style="padding:20px">
        <div style="background:white;padding:20px 10px;border: 1px solid #d8dbe0;border-radius: 0.25rem;">
            ...
            <div class="mb-4 d-flex justify-content-between">
                ...
                @endcan
                {{-- <div>
                    <a class="btn btnstyle"> <i class="bi bi-file-earmark-spreadsheet-fill"></i>Export</a>
                ...
                <div>
                    <form>
                        <input type="hidden" value=""> <input type="file" id="file_import" class="">
            ...
            <livewire:dashboard.product.product-list />
