    ...
    <div style="margin:40px">
        <div class="card p-4">
            ...
            <div class="mb-4 d-flex justify-content-between">
                ...
                <a data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" class="btn btn-primary">
                    Add Year + <i class="bi bi-plus"></i>
                </a>
            ...
            <livewire:dashboard.year.year-list />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Create year</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="POST" action="{{ route('dashboard.year.store') }}">
