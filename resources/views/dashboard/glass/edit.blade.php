        ...
        <div class="card w-50 mx-auto" role="document">
            <div class="">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Update Glass</h3>
                </div>

                <form method="POST" action="{{ route('dashboard.glass.update', $glass->id) }}">
                    <div class="modal-body">
                        @csrf

                        <div class="form-group">
                            <label for="name" class="col-form-label">Glass *</label>
                            <input type="text" class="form-control" name="name" value="{{$glass->name}}" id="name" required>
