...
<!-- BEGIN: Content-->
<div class="app-content content chat-application" style="padding:0px;margin:0px">
                        ...
                        <header class="chat-profile-header">
                            ...
                            <div class="header-profile-sidebar">
                                <div class="avatar box-shadow-1 avatar-xl avatar-border">
                                    <img src="./assets/app-assets/images/portrait/small/avatar-s-11.jpg" alt="user_avatar" />
...
Dessert chocolate cake lemon drops jujubes. Biscuit cupcake ice cream bear claw brownie brownie marshmallow.</textarea>
                    ...
                    <div class="sidebar-content">
                            ...
                            <div class="d-flex align-items-center w-100">
                                <div class="sidebar-profile-toggle">
                                    <div class="avatar avatar-border">
                                        <img src="./assets/app-assets/images/portrait/small/avatar-s-11.jpg" alt="user_avatar" height="42" width="42" />
                        ...
                        <div id="users-list" class="chat-user-list-wrapper list-group">
                            ...
                            <ul class="chat-users-list chat-list media-list">
                                <li>
                                    <span class="avatar"><img src="./assets/app-assets/images/portrait/small/avatar-s-3.jpg" height="42" width="42" alt="Generic placeholder image" />
                                ...
                                <li>
                                    <span class="avatar"><img src="./assets/app-assets/images/portrait/small/avatar-s-7.jpg" height="42" width="42" alt="Generic placeholder image" />
                                ...
                                <li>
                                    <span class="avatar"><img src="./assets/app-assets/images/portrait/small/avatar-s-8.jpg" height="42" width="42" alt="Generic placeholder image" />
                            ...
                            <ul class="chat-users-list contact-list media-list">
                                ...
                                <li>
                                    <span class="avatar"><img src="./assets/app-assets/images/portrait/small/avatar-s-5.jpg" height="42" width="42" alt="Generic placeholder image" />
                                    </span>
                                    <div class="chat-info">
                                ...
                                <li>
                                    <span class="avatar"><img src="./assets/app-assets/images/portrait/small/avatar-s-9.jpg" height="42" width="42" alt="Generic placeholder image" />
                                    </span>
                                    <div class="chat-info">
                                ...
                                <li>
                                    <span class="avatar"><img src="./assets/app-assets/images/portrait/small/avatar-s-15.jpg" height="42" width="42" alt="Generic placeholder image" />
                                    </span>
                                    <div class="chat-info">
                                        <h5 class="mb-0">Kristopher Candy</h5>
                                        <p class="card-text text-truncate">
                                ...
                                <li>
                                    <span class="avatar"><img src="./assets/app-assets/images/portrait/small/avatar-s-14.jpg" height="42" width="42" alt="Generic placeholder image" />
                                    </span>
                                    <div class="chat-info">
                                ...
                                <li>
                                    <span class="avatar"><img src="./assets/app-assets/images/portrait/small/avatar-s-17.jpg" height="42" width="42" alt="Generic placeholder image" />
                                    </span>
                                    <div class="chat-info">
                                ...
                                <li>
                                    <span class="avatar"><img src="./assets/app-assets/images/portrait/small/avatar-s-13.jpg" height="42" width="42" alt="Generic placeholder image" />
                                    </span>
                                    <div class="chat-info">
            ...
            <div class="content-right">
                <div class="content-wrapper container-xxl p-0" style="margin:0px">
                            ...
                            <header class="user-profile-header">
                                ...
                                <div class="header-profile-sidebar">
                                    <div class="avatar box-shadow-1 avatar-border avatar-xl">
                                        <img src="./assets/app-assets/images/portrait/small/avatar-s-7.jpg" alt="user_avatar" height="70" width="70" />
