        ...
        <div class="card p-4">
            ...
            <div class="mb-4 d-flex justify-content-between">
                ...
                <a data-toggle="modal" data-target="#exampleModal" class="btn btn-primary">
                    Add Bodystyle + <i class="bi bi-plus"></i>
                </a>
            ...
            <livewire:dashboard.bodystyle.bodystyle-list />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Create Bodystyle</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="POST" action="{{ route('dashboard.bodystyle.store') }}">
                    <div class="modal-body">

                        @csrf
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Bodystyle *</label>
