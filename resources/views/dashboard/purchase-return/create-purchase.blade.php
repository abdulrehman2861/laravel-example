    ...
    <div class="container-fluid mb-4">
        <div class="row">
            <div class="col-12">
                <div wire:id="X9O45EYwTYSkTvZ8aGnM" class="position-relative">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input wire:keydown.escape="resetQuery" wire:model.debounce.500ms="query" type="text" id="sproduct" class="form-control" placeholder="Type purchase or supplier name or code....">
                                    <input wire:keydown.escape="resetQuery" wire:model.debounce.500ms="query" type="text" class="form-control" placeholder="Type supplier phone number">
                                    <input wire:keydown.escape="resetQuery" wire:model.debounce.500ms="query" type="date" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select wire:keydown.escape="resetQuery" wire:model.debounce.500ms="query" class="form-control" name="supplier_id" id="supplier_id" required="">
                    ...
                    <div class="card  position-absolute   mt-1" style=" display:none; z-index: 2;  left: 0;right: 0;border: 0;" >
                        <div class="card-body shadow">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <a href="#">
                                        ...
                                        PR-00003 ( Supplier : xyz Glass manufacturer , Supplier Phone Number : 86234876 ) ( Total Amount : 1 )
                                    </a>
                ...
                <!-- Livewire Component wire-end:X9O45EYwTYSkTvZ8aGnM -->
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form id="purchase-return-form" action="https://inventory.allstateautoglassinc.com/purchase-returns" method="POST">
