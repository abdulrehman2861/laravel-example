        ...
        <div class="card w-50 mx-auto" role="document">
            <div class="">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Update Customer Type</h3>
                </div>

                <form method="POST" action="{{ route('dashboard.customerType.update', $customerType->id) }}">
                    <div class="modal-body">
                        @csrf

                        <div class="form-group">
                            <label for="name" class="col-form-label">Customer Type Name *</label>
                            <input type="text" name="name" class="form-control" value="{{$customerType->name}}"  placeholder="Enter Expense category" id="name" required>
                        </div>
