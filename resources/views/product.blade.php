                    ...
                    <div class="row">
                                ...
                                <div class="swiper-container single-product-slider">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="assets/images/product/large-size/pngwing.com (2).png" class="single-img gallery-popup">
                                                <img class="img-full" src="assets/images/product/large-size/pngwing.com (2).png" alt="Product Image">
                                            </a>
                                        </div>
                                        <div class="swiper-slide">
                        ...
                        <div class="col-lg-6 pt-9 pt-lg-0">
                            <div class="single-product-content">
                                <h2 class="title mb-3">Auto Glass</h2>
                                    ...
                                    <div class="swiper-wrapper text-heading">
                                        <div class="swiper-slide">
                                            <div class="product-item">
                                                <div class="product-img img-zoom-effect">
                                                    <a href="shop.html">
                                                        <img class="img-full" src="assets/images/product/large-size/glass-.png" alt="Product Images">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-item">
                                                <div class="product-img img-zoom-effect">
                                                    <a href="shop.html">
                                                        <img class="img-full" src="assets/images/product/large-size/glass-2.png" alt="Product Images">
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-item">
                                                <div class="product-img img-zoom-effect">
                                                    <a href="shop.html">
                                                        <img class="img-full" src="assets/images/product/large-size/glass-3.png" alt="Product Images">
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-item">
                                                <div class="product-img img-zoom-effect">
                                                    <a href="shop.html">
                                                        <img style="height: 171px;" class="img-full" src="assets/images/product/large-size/glass-4.png" alt="Product Images">
                                                    </a>
                                                </div>
                                                <div class="product-content">
