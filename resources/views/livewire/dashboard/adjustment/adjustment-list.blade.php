                ...
                <tbody>
                    ...
                    @forelse ($adjustments as $adjustment)
                        <tr>
                            ...
                            <td>{{ $adjustment->reference ?? 'ADJ' }}</td>
                            <td>{{ $adjustment->adjustmentProducts->count() }}</td>
                            <td>

                                @can('edit_adjustments')

                                <a class="btn btn-primary btn-xs"
                                    href="{{ route('dashboard.adjustment.edit', $adjustment->id) }}"><span
                                        class="fas fa-pen"></span></a>
                                @endcan

                                @can('show_adjustments')
                                <a class="btn btn-info btn-xs"
                                        href="{{ route('dashboard.adjustment.show', $adjustment->id) }}"><span
                                            class="fas fa-eye"></span></a>
                                @endcan

                                @can('delete_adjustments')
                                <button
                                    onclick="confirmDelete(`{{ route('dashboard.adjustment.destroy', $adjustment->id) }}`)"
