            ...
            <table wire:loading.remove id="my-all-items-table" class="table table-striped table-bordered"
                ...
                <tbody>
                    ...
                    @forelse ($features as $feature)
                        <tr>
                            <td>{{ $feature->name }}</td>
                            <td>{{ $feature->productFitting->pluck('product')->unique()->count() }}
                            </td>

                            <td>

                                <a class="btn btn-primary btn-xs"
                                    href="{{ route('dashboard.feature.edit', $feature->id) }}"><span
                                        class="fas fa-pen"></span></a>


                                <button
                                    onclick="confirmDelete(`{{ route('dashboard.feature.destroy', $feature->id) }}`)"
