<div>
    <form id="purchase-form" action="{{ route('dashboard.workorder.store') }}" method="POST">
        @csrf
        <input type="hidden" value="wo"name="transaction_type">
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select wire:model.lazy="tax_type" class="form-control" name="tax_type"
                                        ...
                                        @foreach ($taxTypes as $SingleTaxtype)
                                            <option value="{{ $SingleTaxtype }}" {{ old('tax_type') === $SingleTaxtype ? 'selected' : '' }}>
                                                {{ $SingleTaxtype }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="col-lg-4 @if ($tax_type == 'Exempt') d-none @endif" id="global_tax_">
                                <div class="form-group">
                                    ...
                                    <input wire:change="calculateValues" wire:model.lazy="tax" type="number"
                                        ...
                                        max="100" value="{{ old('order_tax') }}" >
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="windsheild_install_type">Windshield Installation Type</label>
                                    <select class="form-control" name="windsheild_install_type"
                                        id="windsheild_install_type">

                                            <option value="">

                                            </option>

                                            <option value="Installation Only">
                                                Installation Only
                                            </option>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-4">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="appointment_time" id="schedule" >
                                            @forelse ($appointmentTimes as $appointmentTime)
                                                <option value="{{ $appointmentTime }}" {{ old('appointment_time') === $appointmentTime ? 'selected' : '' }} >
                                                    {{ $appointmentTime }}
                                                </option>
                                            @empty
                                                <option selected="true" disabled>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control remcus"
                                                            name="customer[name]" value="{{ old('customer.name') }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control remcus"
                                                            name="customer[contact_person]" value="{{ old('customer.contact_person') }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control remcus"
                                                            name="customer[email]" value="{{ old('customer.email') }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control remcus"
                                                            ...
                                                            @forelse ($customerTypes as $customerType)
                                                                <option value="{{ $customerType->id }}" {{ old('customer.customer_Type_id') === $customerType->id ? 'selected' : '' }}>
                                                                    {{ $customerType->name }}
                                                                </option>
                                                            @empty
                                                                <option selected="true" disabled>
                                            ...
                                            <div class="form-row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control remcus"
                                                            name="customer[phone]" value="{{ old('customer.phone') }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control remcus"
                                                            name="customer[phone_alternative]" value="{{ old('customer.phone_alternative') }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control remcus"
                                                            name="customer[fax]" value="{{ old('customer.fax') }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control remcus"
                                                            ...
                                                            <option value="Rate" {{ old('customer.discount_Type') === 'Rate' ? 'selected' : '' }} >Discount in Rates</option>
                                                            <option value="Percentage"  {{ old('customer.discount_Type') === 'Percentage' ? 'selected' : '' }} >Discount in Percentage
                                                            </option>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input id="discount" type="text" class="form-control"
                                                                name="customer[discount]" value="{{ old('customer.discount') }}">
                                                            <div class="input-group-append">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control remcus"
                                                            name="customer[state]" value="{{ old('customer.state') }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control remcus"
                                                            name="customer[city]" value="{{ old('customer.city') }}">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="customer[billing_address]" id="billing_address" rows="4" class="form-control remarea">{{ old('customer.billing_address') }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="customer[service_address]" id="service_address" rows="4" class="form-control remarea">{{ old('customer.service_address') }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label for="notes">Notes </label>
                                                        <textarea name="notes" id="customer[note]" rows="4" class="form-control remarea">{{ old('customer.note') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status" id="status" required="">
                                        @forelse ($transactionStatuses as $transactionStatus)
                                            <option value="{{ $transactionStatus }}" {{ old('status') === $transactionStatus ? 'selected' : '' }}>
                                                {{ $transactionStatus }}
                                            </option>
                                        @empty
                                            <option selected="true" disabled>
                        ...
                        <div class="mt-3">
                            <button type="submit" class="btn btn-primary">
                                Create Work Order <i class="bi bi-check"></i>
                            </button>
                        </div>
