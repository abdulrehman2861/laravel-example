<div>
    <form id="purchase-form" action="{{ route('dashboard.workorder.update',$transaction_id ?? 0) }}" method="POST">
        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select wire:model="windsheild_install_type" class="form-control" name="windsheild_install_type"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select wire:model="service_type" class="form-control" name="service_type" id="servicetype" >
                            ...
                            <div class="col-lg-4">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select wire:model="appointment_time" class="form-control" name="appointment_time" id="schedule" >
                        ...
                        <div class="mt-3">
                            <button type="submit" class="btn btn-primary">
                                Update wokorder <i class="bi bi-check"></i>
                            </button>
                        </div>
