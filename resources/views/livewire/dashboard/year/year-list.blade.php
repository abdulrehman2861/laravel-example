            ...
            <table wire:loading.remove id="my-all-items-table" class="table table-striped table-bordered"
                ...
                <tbody>
                    ...
                    @forelse ($years as $year)
                        <tr>
                            <td>{{ $year->name }}</td>
                            <td>{{ $year->startForProductsFitting->pluck('product')->unique()->count() }}
                            </td>

                            <td>

                                <a class="btn btn-primary btn-xs"
                                    href="{{ route('dashboard.year.edit', $year->id) }}"><span
                                        class="fas fa-pen"></span></a>


                                <button
                                    onclick="confirmDelete(`{{ route('dashboard.year.destroy', $year->id) }}`)"
