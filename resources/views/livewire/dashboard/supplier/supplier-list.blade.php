                            ...
                            <td>
                                @can('edit_suppliers')
                                    <a class="btn btn-primary btn-xs"
                                        href="{{ route('dashboard.supplier.edit', $supplier->id) }}"><span
                                            class="fas fa-pen"></span></a>
                                @endcan

                                @can('show_suppliers')
                                    <a class="btn btn-info btn-xs"
                                        href="{{ route('dashboard.supplier.show', $supplier->id) }}"><span
                                            class="fas fa-eye"></span></a>
                                @endcan

                                @can('edit_suppliers')
                                    <button
                                        onclick="confirmDelete(`{{ route('dashboard.supplier.destroy', $supplier->id) }}`)"
