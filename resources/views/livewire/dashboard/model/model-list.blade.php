            ...
            <table wire:loading.remove id="my-all-items-table" class="table table-striped table-bordered"
                ...
                <tbody>
                    ...
                    @forelse ($models as $model)
                        <tr>
                            <td>{{ $model->name }}</td>
                            <td>{{ $model->bodyStyles->count() }}
                            <td>{{ $model->productFitting->pluck('product')->unique()->count() }}
                            </td>

                            <td>

                                <a class="btn btn-primary btn-xs"
                                    href="{{ route('dashboard.model.edit', $model->id) }}"><span
                                        class="fas fa-pen"></span></a>


                                <button
                                    onclick="confirmDelete(`{{ route('dashboard.model.destroy', $model->id) }}`)"
