                ...
                <tbody>
                    ...
                    @forelse ($sales as $sale)
                        <tr>
                            ...
                            <td><span
                                    class="badge @if ($sale->status == 'Pending') badge-info @elseif($sale->status == 'Ordered' || $sale->status == 'Completed') badge-success @endif ">
                                    {{ $sale->status ?? '-' }} </span> </td>
                            <td>{{ $sale->total_amount }}</td>
                            <td><span
                                    class="badge @if ($sale->payment_status == 'Unpaid') badge-danger @elseif($sale->payment_status == 'Returned' || $sale->payment_status == 'Paid') badge-success @endif ">
                                    {{ $sale->payment_status ?? '-' }} </span> </td>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary btn-xs"
                                    href="{{ route('dashboard.sale.edit', $sale->id) }}"><span
                                        class="fas fa-pen"></span></a>

                                <a class="btn btn-info btn-xs"
                                    href="{{ route('dashboard.sale.show', $sale->id) }}"><span
                                        class="fas fa-eye"></span></a>


                                <button onclick="confirmDelete(`{{ route('dashboard.sale.destroy', $sale->id) }}`)"
