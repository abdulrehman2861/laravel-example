<div>
    <form id="purchase-form" action="{{ route('dashboard.sale.update',$transaction_id) }}" method="POST">
        @csrf
                                ...
                                <table class="table table-bordered">
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th class="align-middle">Shippment/Pickup</th>
                                                    ...
                                                    <div class="input-group">
                                                        <div style="margin: 8px">
                                                            @if($product['is_pickup'])
                                                                <span class="badge badge-success">Pickup ({{ $product['pickup_location'] }})</span>
                                                            @else
                                                                <span class="badge badge-danger">Shippment ({{ $product['shipping_provider'] . '-' . $product['shipping_status'] }})</span>
                                                            @endif
                                                            @if($product['shipping_status'] == 'pending')
                                                                @if($product['shipping_provider'] == 'UPS')
                                                                    <a class="badge badge-warning pointer-event" type="button" id="ups-btn" data-id="{{ $product['detail_id'] }}">
                                                                        <i class="fa fa-pen-square text-white"></i>
                                                                    </a>
                                                                @elseif($product['shipping_provider'] == 'FedEx')
                                                                    <a class="badge badge-warning pointer-event" href="#" data-toggle="modal" data-target="#fedexModal">
                                                                        <i class="fa fa-pen-square text-white"></i>
                                                                    </a>
                                                                @endif
                                                            
                                                            @else
                                                                <a class="badge badge-warning pointer-event" href="{{ route('dashboard.shipment.ups.getLabelImage', $product['detail_id']) }}" target="__blank">
                                                                    View Label
                                                                </a>
                                                            @endif
                                                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="col-lg-4 cus @if ($existingCustomer == false) d-none @endif " style="">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select wire:model="customer_id" class="form-control" name="customer_id" id="customer_id"
                                            required="">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select wire:model="service_type" class="form-control" name="service_type" id="servicetype" required>
                            ...
                            <div class="col-lg-4 d-none">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select wire:model="appointment_time" class="form-control " name="appointment_time" id="schedule" required>
                            ...
                            <div class="col-lg-4">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select wire:model="installer_id" class="form-control" name="installer_id" id="inst_id">
                        ...
                        <div class="form-row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" wire:model="so_no" class="form-control"
                                        readonly="" >
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <input type="date"  wire:model="appointment_date" class="form-control" name="appointment_date"
                                            >
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea wire:model="note" name="note" id="note" rows="5" class="form-control"></textarea>
                        </div>
