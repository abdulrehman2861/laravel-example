                ...
                <tbody>
                    ...
                    @forelse ($installers as $installer)
                        <tr>
                            ...
                            <td>{{ $installer->social_security_number }}</td>
                            <td>{{ $installer->phone }}</td>

                            <td>

                                <a class="btn btn-primary btn-xs"
                                    href="{{ route('dashboard.installer.edit', $installer->id) }}"><span
                                        class="fas fa-pen"></span></a>


                                <button
                                    onclick="confirmDelete(`{{ route('dashboard.installer.destroy', $installer->id) }}`)"
