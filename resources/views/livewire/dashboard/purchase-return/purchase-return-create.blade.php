<div class="container-fluid mb-4">
                            ...
                            <div class="col-lg-6">
                                <div class="from-group">
                                    <div class="form-group">
                                        ...
                                        <select wire:model="searchSupplier" class="form-control" name="supplier_id"
                                ...
                                @forelse ($transactions as $transactionListItem)
                                    <li class="list-group-item list-group-item-action">
                                        <a wire:click.prevent="selectTransaction({{ $transactionListItem->id }})"
                                            ...
                                            {{ $transactionListItem->purchase_no }} ( Supplier :
                                            {{ $transactionListItem->supplier?->name }} , Supplier Phone Number :
                                            {{ $transactionListItem->supplier?->phone }}
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form id="purchase-return-form" action="{{ route('dashboard.purchase-return.store') }}"
                        method="POST">
                        @csrf
                        <input wire:model="selectedTransactionId" type="hidden" name="purchase_transaction_id" value="{{$selectedTransactionId}}">
                        {{-- <div class="form-row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="reference">Reference <span class="text-danger">*</span></label>
