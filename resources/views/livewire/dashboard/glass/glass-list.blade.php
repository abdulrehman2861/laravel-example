            ...
            <table wire:loading.remove id="my-all-items-table" class="table table-striped table-bordered"
                ...
                <tbody>
                    ...
                    @forelse ($glasses as $glass)
                        <tr>
                            <td>{{ $glass->name }}</td>
                            <td>{{ $glass->productFitting->pluck('product')->unique()->count() }}
                            </td>

                            <td>

                                <a class="btn btn-primary btn-xs"
                                    href="{{ route('dashboard.glass.edit', $glass->id) }}"><span
                                        class="fas fa-pen"></span></a>


                                <button
                                    onclick="confirmDelete(`{{ route('dashboard.glass.destroy', $glass->id) }}`)"
