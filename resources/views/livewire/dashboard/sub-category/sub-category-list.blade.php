<div>
    <div class="row table-setting" style="padding:10px">
        <div class="col-md-12 ">
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    <div style="display: flex; justify-content: end;" id="datatable_filter" class=""><label
                            class="labelstyle">Search: <input  wire:model="searchKey" type="search" class="form-control input-sm"
            ...
            <table wire:loading.remove id="my-all-items-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                ...
                <tbody>
                    @forelse ($subCategories as $subCategory)
                        <tr>
                            ...
                            <td>{{ $subCategory->productFitting->pluck('product')->unique()->count() }}
                            </td>

                            <td>

                                <a class="btn btn-primary btn-xs"
                                    href="{{ route('dashboard.subcategory.edit', $subCategory->id) }}"><span
                                        class="fas fa-pen"></span></a>


                                <button
                                    onclick="confirmDelete(`{{ route('dashboard.subcategory.destroy', $subCategory->id) }}`)"
