    ...
    <li class="nav-item">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              {{-- <a class="dropdown-item" href="{{url('profile/user')}}"><i class="fas fa-user"></i> Profile</a> --}}
              <a class="dropdown-item text-danger" href="{{route('customer.dashboard.logout')}}" ><i class="fas fa-sign-out-alt"></i> Logout</a>
            </div>
          </div>
